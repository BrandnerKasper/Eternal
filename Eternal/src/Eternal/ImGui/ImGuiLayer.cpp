...
namespace Eternal {
	...
	void ImGuiLayer::OnAttach()
	{
		...
		//Add temporary!!! use own kex codes!
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		//checks which type and calls right function
		...
		dispatcher.Dispatch<WindowResizeEvent>(ET_BIND_EVENT_FN(ImGuiLayer::OnWindowResizedEvent));
	...
	bool ImGuiLayer::OnKeyTypedEvent(KeyTypedEvent& e) //maybe later
	{
		ImGuiIO& io = ImGui::GetIO();
